        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20">
          <div>
            ...
            <div className="space-y-8">
              ...
              <div>
                <p className="text-[10px] uppercase tracking-widest text-gray-500 mb-2">
                  {t("contact.inquiries") !== "contact.inquiries" ? t("contact.inquiries") : "Email"}
                </p>
                <a
                  href="mailto:tina@elapack.com"
                  className="text-lg font-playfair hover:text-brand-gold transition-colors"
                >
                  tina@elapack.com
                </a>
              </div>
              <div>
                ...
                <a
                  ...
                  className="text-lg font-playfair hover:text-brand-gold transition-colors flex items-center gap-2"
                >
